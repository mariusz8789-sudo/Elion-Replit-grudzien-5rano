...
**Energia wiązania — SEMF (Weizsäcker)** ★★★★ (model), dane ★★★★★
B = a_V·A − a_S·A^⅔ − a_C·Z²/A^⅓ − a_A·(A−2Z)²/A ± δ·A^{−½};
(a_V≈15,8; a_S≈17,8; a_C≈0,71; a_A≈23,7; δ≈11,2 MeV).
Wyjaśnia dolinę stabilności i dlaczego rozszczepienie (A>56) i fuzja (A<56)
uwalniają energię. Dokładne masy: AME2020/NNDC.
...
- Mapa nuklidów: pakiet danych NNDC (Z, N, T½, mod) ~50–100 kB — OK
...
3. Mapa nuklidów N–Z (dane NNDC) — „układ okresowy 2.0", most do Atom Lab

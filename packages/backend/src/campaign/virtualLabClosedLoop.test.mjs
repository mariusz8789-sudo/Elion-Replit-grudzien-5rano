...
describe('Test: real execution — molecular-docking (AutoDock Vina, genuinely available in this runtime)', () => {
  test('a docking virtual experiment executes for real and persists a real ScienceRun', () => {
    const { campaignId, candidateId } = seedCampaignAndCandidate(db);
    const planned = planVirtualExperiment(db, {

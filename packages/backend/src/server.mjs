...
const server = http.createServer((req, res) => {
  ...
  if (req.url?.startsWith('/api/auth/') || req.url?.startsWith('/api/projects') || req.url?.startsWith('/api/compute') || req.url?.startsWith('/api/worlds') || req.url?.startsWith('/api/security') || req.url?.startsWith('/api/speculative') || req.url?.startsWith('/api/knowledge') || req.url?.startsWith('/api/quantum')) {

...
const ALLOWED_ORPHANS: Readonly<Record<string, string>> = {
  ...
  'core/biotechData/qe4RegimeRound.ts': 'Discovery Engine P0-6: per-round fingerprint/replay over P0.1+P0.2 output. Awaits the planner (P0-1) and stopping rules (P0-3) that will make a "round" a full campaign step; its own tests prove replay MATCH/DRIFT today.',

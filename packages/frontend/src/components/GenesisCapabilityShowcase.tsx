...
export function GenesisCapabilityShowcase() {
  ...
  const capabilities: Capability[] = [
    ...
    { id: 'biology', label: 'Biology', description: 'Target, evidence, comparison and validation-request surfaces using active executors.', status: 'BACKEND-GATED', action: 'Review biology', hash: '#/lab/biology', note: 'Independent biological observation is not supplied by software' },

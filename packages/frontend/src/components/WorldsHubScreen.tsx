...
export const WORLDS: readonly WorldEntry[] = [
  {
    id: 'city3d', hash: '#/city3d', glyph: '◫', title: 'Miasto epidemiologiczne', domain: 'Epidemiology World', featured: true,
  ...
  {
    id: 'lab-3d', hash: '#/lab-3d', glyph: '⌬', title: 'Wirtualne laboratorium', domain: 'Virtual Lab', featured: true,
  ...
  {
    id: 'molecule', hash: '#/molecule', glyph: '⬡', title: 'Molecule World', domain: 'Molecular World', featured: true,
  ...
  {
    id: 'discovery-hall', hash: '#/discovery-hall', glyph: '◈', title: 'Discovery Hall', domain: 'Winner Gate', featured: true,
  ...
  {
    id: 'scientific-city', hash: '#/scientific-city', glyph: '▦', title: 'Scientific City', domain: 'Infrastructure World',
  ...
  {
    id: 'cell-lab', hash: '#/cell-lab', glyph: '◌', title: 'Virtual Cell Lab', domain: 'Biology World',
  ...
  {
    id: 'genesis-world', hash: '#/genesis-world', glyph: '◍', title: 'World Engine', domain: 'Environment World',
  ...
  {
    id: 'timeline', hash: '#/timeline', glyph: '◠', title: 'Discovery Timeline', domain: 'Cosmos World',

...
import { GENESIS_ATOMIC_IONIZATION_CATALOG, GENESIS_ATOMIC_IONIZATION_CATALOG_ID } from './atomicIonizationLeverCatalog';
...
export const WORLD_LEVER_CATALOGS: Readonly<Record<string, WorldLeverCatalog>> = {
  ...
  [GENESIS_ATOMIC_IONIZATION_CATALOG_ID]: GENESIS_ATOMIC_IONIZATION_CATALOG,
};

...
function biotechKnowledgeResult(request: StructuredExperimentRequest): ExperimentResult | undefined {
  ...
  return {
    ...
    outputs: {
      ...
      xLogP: record.compound.adme.xLogP,
      tpsa: record.compound.adme.tpsa,
      hydrogenBondDonorCount: record.compound.adme.hydrogenBondDonorCount,
      hydrogenBondAcceptorCount: record.compound.adme.hydrogenBondAcceptorCount,
      rotatableBondCount: record.compound.adme.rotatableBondCount,
      ...
      admeSource: record.compound.adme.source,
      admeSourceId: record.compound.adme.sourceId,
      admeSourceUrl: record.compound.adme.sourceUrl,
    },

...
/** Five fixture sites at varying distance/vulnerability from a nominal origin — purely for exercising the pipeline. */
export const SYNTHETIC_EXPOSURE_SITES: readonly ExposureSite[] = [
  { siteId: 'site-alpha', assetLabel: 'Fixture Site Alpha (near-field)', vulnerabilityClass: 'HIGH', x: 2, y: 1 },
  { siteId: 'site-bravo', assetLabel: 'Fixture Site Bravo (near-field)', vulnerabilityClass: 'MEDIUM', x: -3, y: 2 },
  { siteId: 'site-charlie', assetLabel: 'Fixture Site Charlie (mid-field)', vulnerabilityClass: 'MEDIUM', x: 15, y: -10 },
  { siteId: 'site-delta', assetLabel: 'Fixture Site Delta (mid-field)', vulnerabilityClass: 'LOW', x: -20, y: 8 },
  { siteId: 'site-echo', assetLabel: 'Fixture Site Echo (far-field)', vulnerabilityClass: 'LOW', x: 60, y: 40 },
];

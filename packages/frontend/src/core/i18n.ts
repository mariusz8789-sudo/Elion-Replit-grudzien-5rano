...
const EXPLORER_EN: Dictionary = {
  ...
  'explorer.section': 'Section', 'explorer.cutaway': 'Cut', 'explorer.isolate': 'Isolate organ', 'explorer.showAll': 'Show all', 'explorer.anatomyModel': 'ANATOMY: MODEL', 'explorer.twinCamera': 'Twin camera',
  'explorer.sectionNote': 'The section reveals the atlas model volumes — a schematic, not a medical cross-section of a patient.',
...
const pl: Dictionary = {
  ...
  'explorer.section': 'Przekrój', 'explorer.cutaway': 'Przetnij', 'explorer.isolate': 'Izoluj narząd', 'explorer.showAll': 'Pokaż wszystko', 'explorer.anatomyModel': 'ANATOMIA: MODEL', 'explorer.twinCamera': 'Kamera bliźniaka',
  'explorer.sectionNote': 'Przekrój odsłania modelowe bryły narządów z atlasu — to schemat, nie medyczny przekrój pacjenta.',

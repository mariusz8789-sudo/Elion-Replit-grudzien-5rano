...
const DOMAIN_REGISTRY: readonly KnowledgeDomainDescriptor[] = [
  ...
  },
  {
    ...
    capability: 'REAL_ENGINE', realModels: ['chemistry-arrhenius', 'chemistry-ising', 'chem-molecular-weight', 'chem-rdkit-descriptors'],
    concepts: ['Arrhenius', 'VSEPR', 'miareczkowanie', 'Ising', 'magnetyzacja spontaniczna', 'masa molowa'],
    parameters: ['temperatureK', 'activationEnergyKJ', 'temperature', 'seed', 'formula', 'smiles'], units: ['K', 'kJ/mol', 'J/k_B', 'g/mol'],
    assumptions: ['Ising używa 2D siatki kwadratowej J=1, najbliższych sąsiadów, periodycznych brzegów oraz seedowanego Metropolisa; dokładna magnetyzacja jest referencją granicy termodynamicznej, a pojedynczy run na 42×42 nie jest miarą niepewności. Molecular dynamics, docking i quantum chemistry wymagają zewnętrznych silników.'],
    possibleExperiments: ['oblicz kinetykę reakcji', 'uruchom 2D model Isinga', 'oblicz masę molową', 'analizuj cząsteczkę'], requiredSolver: 'ModelGraph / Ising Metropolis / RDKit capability',
  ...
  },
  {
    ...
    capability: 'CAPABILITY_SEAM', realModels: ['quantum-bloch', 'quantum-bloch-circuit', 'quantum-tunneling-1d', 'chsh-correlation', 'quantum-chsh-correlation', 'quantum-kitaev-bulk'],
    concepts: ['superpozycja', 'interferencja', 'splątanie', 'tunelowanie', 'kubit', 'bramki', 'bulk BdG', 'łańcuch Kitaeva'], parameters: ['theta', 'phi', 'circuit', 'a', 'aP', 'b', 'bP', 'energy', 'barrier', 'width', 'chemicalPotential', 'hopping', 'pairing'], units: ['rad', 'jedn. energii'],
    ...
    possibleExperiments: ['wykonaj obwód jednokubitowy Blocha', 'oblicz analityczną korelację CHSH', 'pokaż stan kubitu', 'zbadaj korelację CHSH', 'oblicz bulk gap łańcucha Kitaeva'], requiredSolver: 'single-qubit matrices / quantumState / Schrödinger solver required for tunneling; Q1 Kitaev bulk dostępny dla zdefiniowanego modelu',
  ...
  },
  {
    ...
    capability: 'REAL_ENGINE', realModels: ['universe-kepler', 'universe-atmospheric-escape', 'universe-hubble-tension', 'universe-planet-stability', 'universe-starlife', 'universe-galaxy-collision', 'universe-rotation-curve'],
    concepts: ['ΛCDM', 'ekspansja', 'galaktyki', 'ciemna materia', 'soczewkowanie', 'planety', 'życie gwiazdy', 'ogony pływowe', 'krzywa rotacji'],
    parameters: ['centralMassSolar', 'orbitalRadiusAu', 'stellarLuminositySolar', 'planetMassEarth', 'extraSystematic', 'showTrgb', 'years', 'jupiter', 'saturn', 'massSolar', 'ratio', 'retro', 'horizonMyr', 'haloVInf', 'altGravity'], units: ['AU', 'yr', 'K', 'M☉', 'M⊕', 'km/s/Mpc', 'lat', 'mld lat', 'L☉', 'mln lat (skalowanie widoku)', 'km/s', 'kpc'],
    ...
    possibleExperiments: ['oblicz orbitę planety', 'zbadaj ucieczkę atmosfery', 'porównaj napięcie Hubble’a', 'zbadaj stabilność planet', 'zbadaj skalowanie życia gwiazdy', 'zbadaj ograniczone zderzenie galaktyk', 'porównaj krzywą rotacji halo i MOND'], requiredSolver: 'universe-kepler / universe-atmospheric-escape / universe-hubble-tension / universe-planet-stability / universe-starlife / universe-galaxy-collision / universe-rotation-curve',
    visualization: ['numeric', 'graph', 'scene-3d'], dependencies: ['classical-mechanics', 'spacetime-einstein'], keywords: ['wszechświat', 'kosmologia', 'planeta', 'orbita', 'atmosfera', 'galaktyka', 'soczewkowanie', 'gwiazda', 'supernowa', 'biały karzeł', 'zderzenie galaktyk', 'ogony pływowe', 'krzywa rotacji', 'ciemna materia', 'mond'],
  },
] as const;

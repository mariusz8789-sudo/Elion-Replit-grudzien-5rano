...
/** Deterministic per-cell value in [0,1): a 2D index mixed into a seed, then the first mulberry32 draw. */
function hashUnit(seed: number, x: number, y: number): number {
  return mulberry32((seed * 0x9e3779b1 + x * 0x85ebca6b + y * 0xc2b2ae35) >>> 0)();
}

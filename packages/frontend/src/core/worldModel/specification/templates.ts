...
import {
  COSMOLOGY_SPACETIME_TEMPLATE,
  DESERT_ALIEN_TEMPLATE,
  EINSTEIN_ROSEN_BRIDGE_TEMPLATE,
  HISTORICAL_RECONSTRUCTION_TEMPLATE,
  MARS_RESEARCH_TEMPLATE,
  MULTIVERSE_BRANCH_TEMPLATE,
  QUANTUM_TEMPLATE,
  TIME_DILATION_LAB_TEMPLATE,
} from './spacetimeTemplates';
...
export const WORLD_TEMPLATES: Record<import('./worldSpecification').WorldTemplateId, WorldTemplate> = {
  ...
  // Spacetime product-binding templates (specification/spacetimeTemplates.ts) — see that
  // file's own header for what each one does and does not claim.
  EINSTEIN_ROSEN_BRIDGE: EINSTEIN_ROSEN_BRIDGE_TEMPLATE,
  MULTIVERSE_BRANCH: MULTIVERSE_BRANCH_TEMPLATE,
  TIME_DILATION_LAB: TIME_DILATION_LAB_TEMPLATE,
  QUANTUM: QUANTUM_TEMPLATE,
  COSMOLOGY_SPACETIME: COSMOLOGY_SPACETIME_TEMPLATE,
  HISTORICAL_RECONSTRUCTION: HISTORICAL_RECONSTRUCTION_TEMPLATE,
  DESERT_ALIEN: DESERT_ALIEN_TEMPLATE,
  MARS_RESEARCH: MARS_RESEARCH_TEMPLATE,
};

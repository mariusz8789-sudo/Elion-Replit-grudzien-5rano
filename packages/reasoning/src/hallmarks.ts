...
export const MECHANISTIC_EDGES: MechanisticEdge[] = [
  { from: 'telomere-attrition', to: 'cellular-senescence', effect: 'promotes', honesty: 'exact',
    ...
    citations: [{ doi: '10.1038/nature02118', label: "d'Adda di Fagagna 2003", checked: 'cross-checked' }] },
  { from: 'telomerase', to: 'telomere-attrition', effect: 'counteracts', honesty: 'exact',
    ...
    citations: [{ doi: '10.1126/science.279.5349.349', label: 'Bodnar 1998', checked: 'cross-checked' }] },
  { from: 'cellular-senescence', to: 'sasp', effect: 'promotes', honesty: 'exact',
    ...
    citations: [{ pmid: '19053174', doi: '10.1371/journal.pbio.0060301', label: 'Coppé 2008', checked: 'cross-checked' }] },
  { from: 'sasp', to: 'cellular-senescence', effect: 'promotes', honesty: 'exact',
    ...
    citations: [{ pmid: '18555777', doi: '10.1016/j.cell.2008.03.038', label: 'Acosta 2008', checked: 'cross-checked' }] },
  { from: 'dna-repair', to: 'cellular-senescence', effect: 'counteracts', honesty: 'exact',
    ...
    citations: [{ pmid: '22426077', doi: '10.1038/ncb2466', label: 'Fumagalli 2012', checked: 'cross-checked' }] },
  { from: 'dna-repair', to: 'telomere-attrition', effect: 'counteracts', honesty: 'simplified',
    ...
    citations: [{ pmid: '12114022', doi: '10.1016/s0968-0004(02)02110-2', label: 'von Zglinicki 2002', checked: 'cross-checked' }] },
  { from: 'mitochondrial-dysfunction', to: 'cellular-senescence', effect: 'promotes', honesty: 'simplified',
    ...
    citations: [{ doi: '10.1016/j.cmet.2015.11.011', label: 'Wiley 2016', checked: 'cross-checked' }] },
  { from: 'autophagy', to: 'mitochondrial-dysfunction', effect: 'counteracts', honesty: 'exact',
    ...
    citations: [{ pmid: '19029340', label: 'Narendra 2008', checked: 'cross-checked' }] },
  { from: 'yamanaka-factors', to: 'epigenetic-reprogramming', effect: 'promotes', honesty: 'exact',
    ...
    citations: [{ pmid: '16904174', doi: '10.1016/j.cell.2006.07.024', label: 'Takahashi 2006', checked: 'cross-checked' }] },
  { from: 'epigenetic-reprogramming', to: 'cellular-senescence', effect: 'counteracts', honesty: 'theoretical',
    ...
    citations: [{ pmid: '27984723', doi: '10.1016/j.cell.2016.11.052', label: 'Ocampo 2016', checked: 'cross-checked' }] },
  { from: 'cellular-senescence', to: 'stem-cell-rejuvenation', effect: 'counteracts', honesty: 'simplified',
    ...
    citations: [{ pmid: '26840489', doi: '10.1038/nature16932', label: 'Baker 2016', checked: 'cross-checked' }] },
  { from: 'sasp', to: 'stem-cell-rejuvenation', effect: 'counteracts', honesty: 'simplified',
    ...
    citations: [{ pmid: '27111842', doi: '10.1038/ncb3346', label: 'Pietras 2016', checked: 'cross-checked' }] },
  { from: 'autophagy', to: 'stem-cell-rejuvenation', effect: 'promotes', honesty: 'simplified',
    ...
    citations: [{ pmid: '26738589', doi: '10.1038/nature16187', label: 'García-Prat 2016', checked: 'cross-checked' }] },
];

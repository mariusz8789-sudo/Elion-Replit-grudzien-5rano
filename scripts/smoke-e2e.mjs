...
const ROUTES = ['', '#/tour', '#/research-console?guide=1', '#/worlds', '#/discovery-hall', '#/settings', '#/glossary', '#/discovery-log', '#/what-if', '#/timeline', '#/decision-explorer', '#/reality', '#/prebuild', '#/conflict', '#/projects', '#/cde', '#/drug', '#/gov-campaign', '#/campaign', '#/inquiry'];
